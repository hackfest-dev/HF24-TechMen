      ...
      <div className="w-[700px] m-auto text-xl">
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="item-1">
            ...
            <AccordionContent className="text-base">
              Around <span className="text-[rgb(225,29,73)]">15M</span> babies
              ...
              <span className="text-[rgb(225,29,73)]">32-35 weeks</span> have{" "}
              <span className="text-[rgb(225,29,73)]">50%</span> chances of
              developing
